...
the manager can segmente multiple images concurrently.

This only works for 6patches network and Theano backend.
"""
import os
import sys
import nibabel as nib
from scipy.io import savemat
from utils.utils import get_largest_component
from network import Cnn3DPatch
from utils.voxel_feature import Pick3DPatchMultiScale
from cnn_utils_harp import segment_by_generator
...
def segment_image_3DPatch(img_pathes, mask_pathes,
    ...
    for img_path, mask_path in zip(img_pathes, mask_pathes):
        ...
        pred_lab = get_largest_component(pred_lab)
        data = {}
        data['label'] = pred_lab
...
if __name__ == '__main__':
    ...
    segment_image_3DPatch(img_pathes, mask_pathes,
                          model_path, stats_path,
                          n_classes, patch_size, scales,
                          batch_size, gpu_batch_size,
                          out_dir)
