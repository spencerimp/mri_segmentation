...
# APIs
def segment_triplanar_cent(img_pathes, mask_pathes,
                           prediction_worker,
                           model_path, stats_path,
                           n_classes, patch_size, scales,
...
if __name__ == '__main__':
    ...
    prediction_worker = './prediction_worker6patch_cent.py'
    model_path = './experiments/keras/6patch_cent_bn3/cnn_6patch_cent.h5'
    stats_path = './experiments/keras/6patch_cent_bn3/cnn_6patch_cent_stat.h5'
    n_classes = 135
    patch_size = 29
    scales = [1, 3]
    batch_size = 200000
    gpu_batch_size = 40000
    out_dir = './experiments/keras/6patch_cent_debug/'
    gpus = ['gpu0', 'gpu1', 'gpu2', 'gpu3']

    start_time = time.time()
    segment_triplanar_cent(test_img_pathes, mask_dir,
                           prediction_worker,
                           model_path, stats_path,
                           n_classes, patch_size, batch_size,
                           gpus, gpu_batch_size,
                           out_dir)
