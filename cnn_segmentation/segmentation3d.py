...
# APIs
def segment_images3DPatch(img_pathes, mask_pathes,
                          prediction_worker,
                          model_path, stats_path,
                          n_classes, patch_size, scales,
                          batch_size,
...
if __name__ == '__main__':
    ...
    prediction_worker = './prediction_worker6patches.py'
    model_path = './experiments/keras/6patches_set2/cnn_6patches.h5'
    stats_path = './experiments/keras/6patches_set2/cnn_6patches_stat.h5'
    n_classes = 135
    patch_size = 13
    scales = [1]
    batch_size = 200000
    gpu_batch_size = 40000
    out_dir = './experiments/keras/6patches_set2/cheat/'
