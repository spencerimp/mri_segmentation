...
from train_triplanar import (
    train_triplanar,
)
from segmentation_triplanar import segment_triplanar
from assess_segmentation import compute_performance


# pipeline configs
nib.nifti1.Nifti1Header.quaternion_threshold = -1e-6
out_process_time = './experiments/keras/triplanar/process_time.txt'
is_reset_exp = True
...
logger_path = './experiments/keras/triplanar/train_triplanar_log.csv'
n_classes = 135
patch_size = 29
scales = [1, 3]
n_voxels_tr = 60000
...
train_triplanar(train_img_pathes, train_lab_pathes,
